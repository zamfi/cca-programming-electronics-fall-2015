...
- Start your final project's **debug log**.
  ...
  6. Repeat steps 3-5 above until you resolve your "bug".
  ...
  **Create a `debug-log.md` file in your final project repository, and keep your notes in there. [Send me a link to your file (it should have a record of what you've done so far!)](mailto:jzamfirescupereira@cca.edu) by Monday night, 11pm**.
